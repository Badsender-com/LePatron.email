function extendLinkColor() {
  tinymce.PluginManager.add('linkcolor', function (editor) {
    var attachState = {};
    ...
    function leftClickedOnAHref(elm) {
      var sel, rng, node;
      if (
        editor.settings.link_context_toolbar &&
    ...
    function showDialog(linkList) {
      ...
      if (selectedElm) {
        ...
        var currentTextDecoration = computedStyle.getPropertyValue(
          'text-decoration'
        );
            ...
            items: [
              {
                ...
                name: 'colorpicker',
                onchange: function () {
                  data.color = this.value().substr(1);

                  if (win) {
                    win.find('#colortext').value(this.value().substr(1));
                  ...
                  },
                  {
                    ...
                    onchange: function () {
                      ...
                      if (win) {
                        ...
                        colorPickerCtrl.value('#' + this.value());
                        showPreview('#' + this.value());
                      }
                    },
                  },
    ...
    editor.addButton('linkcolorbutton', {
      icon: 'link',
    ...
    editor.addButton('unlinkcolorbutton', {
      icon: 'unlink',
      tooltip: 'Remove link',
      cmd: 'unlink',
      stateSelector: 'a[href]',
    ...
    if (editor.addContextToolbar) {
      ...
      editor.addContextToolbar(leftClickedOnAHref, 'openlink | link unlink');
    }
...
module.exports = extendLinkColor;
