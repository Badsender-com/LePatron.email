...
var express = require('~/editor/backend/express');
var upload = require('~/editor/backend/jquery-file-upload-middleware');
var bodyParser = require('~/editor/backend/body-parser');
var fs = require('fs');
var _ = require('~/editor/backend/lodash');
var app = express();
var gmagic = require('~/editor/backend/gm');
var gm = gmagic.subClass({imageMagick: true});
var config = require('../server-config.js');
var extend = require('util')._extend;
var url = require('url');

app.use(require('~/editor/backend/connect-livereload')({ ignore: [/^\/dl/, /^\/img/] }));
...
app.post('/dl/', function(req, res) {
    var response = function(source) {
        ...
        if (req.body.action == 'download') {
            ...
            var nodemailer = require('~/editor/backend/nodemailer');
...
app.use('/templates', express.static(__dirname + '/../packages/editor/templates'));
