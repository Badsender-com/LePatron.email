...
- you read this Readme _three_ times and followed the instructions
...
- tell us the browser you are using (name and version) and test at least a _second_ browser to tell us if this happen in both or only one (tell us the details about the second browser too).
