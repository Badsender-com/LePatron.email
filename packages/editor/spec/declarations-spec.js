...
describe('Style declaration processor', function () {
  it('should not loose simple properties after a -ko-property', function () {
    ...
    previewBindings = elaborateDeclarations(
      undefined,
      declarations,
    ...
    expect(previewBindings).toEqual(
      "virtualAttrStyle: 'color: '+($color[undefined]())+'; '+'background-color: white;'+''"
    );
  ...
  it('should not mix virtualStyle and virtualAttrStyle bindings', function () {
    ...
    expect(previewBindings).toEqual(
      "virtualAttrStyle: 'padding-left: 5px; '+'padding: 5px;'+'', text: 'Pulsante', virtualStyle: { fontFamily: $face[undefined](), color: $color[undefined](), fontSize: $size[undefined]()+'px', backgroundColor: $buttonColor[undefined](), borderRadius: $radius[undefined]()+'px' }"
    );
  });

  it('should mantain spaces and ; when removing/replacing declarations', function () {
    var result;
    result = elaborateDeclarations(
      'color: red; -ko-color: @color; background-color: white',
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    ...
    expect(result).toEqual(
      'color: red; color: <!-- ko text: $color[red]() -->red<!-- /ko -->; background-color: white'
    );
  ...
  it('should support modifiers', function () {
    var result;
    result = elaborateDeclarations(
      'width: 10%; -ko-width: @[mywidth]%',
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    );
    expect(result).toEqual(
      "width: 10%; width: <!-- ko text: $mywidth[10]()+'%' -->10%<!-- /ko -->"
    );

    result = elaborateDeclarations(
      'width: 10px; -ko-width: @[mywidth]px',
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    );
    expect(result).toEqual(
      "width: 10px; width: <!-- ko text: $mywidth[10]()+'px' -->10px<!-- /ko -->"
    );

    result = elaborateDeclarations(
      "src: url('path'); -ko-src: url('@myurl')",
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    );
    expect(result).toEqual(
      "src: url('.path'); src: <!-- ko text: 'url(\\''+$myurl[.path]()+'\\')' -->url('.path')<!-- /ko -->"
    );
  ...
  it('should support composed properties and hardcoded values', function () {
    var result;
    result = elaborateDeclarations(
      'border: 1px 2px 3px 4px; -ko-border: @border1 @border2 3px @border4',
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    );
    expect(result).toEqual(
      "border: 1px 2px 3px 4px; border: <!-- ko text: $border1[1px]()+' '+$border2[2px]()+' 3px '+$border4[4px]() -->1px 2px 3px 4px<!-- /ko -->"
    );
  });
  ...
  it('should support conditional properties', function () {
    ...
    expect(result).toEqual(
      "virtualAttrStyle: 'color: '+(($mycondition[undefined]()) ? $mycolor[undefined]() : null)+';'+''"
    );
    ...
    expect(result).toEqual(
      'color: red; color: <!-- ko text: ($mycondition[undefined]()) ? $mycolor[red]() : null -->red<!-- /ko -->; '
    );
  });
  ...
  it('should support simple expressions in conditional properties', function () {
    ...
    expect(result).toEqual(
      "virtualAttrStyle: 'color: '+(((($mycondition[undefined]() > 1) && ($mycondition[undefined]() < 3))) ? $mycolor[undefined]() : null)+';'+''"
    );
    ...
    expect(result).toEqual(
      'color: red; color: <!-- ko text: ((($mycondition[undefined]() > 1) && ($mycondition[undefined]() < 3))) ? $mycolor[red]() : null -->red<!-- /ko -->; '
    );

    result = elaborateDeclarations(
      'color: red; -ko-color: @mycolor; -ko-color-ifnot: mycondition gt 1 and mycondition lt 3',
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    );
    ...
    result = elaborateDeclarations(
      'color: red; -ko-color: @mycolor; -ko-color-ifnot: mycondition eq "ciao ciao"',
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    );
    expect(result).toEqual(
      'color: red; color: <!-- ko text: !(($mycondition[undefined]() == "ciao ciao")) ? $mycolor[red]() : null -->red<!-- /ko -->; '
    );
  });
  ...
  it('should support complex expressions in conditional properties', function () {
    var result;
    result = elaborateDeclarations(
      'color: red; -ko-color: @mycolor; -ko-color-ifnot: mycondition eq "ciao ciao" and mycondition neq "miao" or mycondition lte 1 or Color.lighter(mycondition, "#00000") gte "#CCCCCC"',
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    );
    expect(result).toEqual(
      'color: red; color: <!-- ko text: !((((($mycondition[undefined]() == "ciao ciao") && ($mycondition[undefined]() != "miao")) || ($mycondition[undefined]() <= 1)) || (Color.lighter($mycondition[undefined](), "#00000") >= "#CCCCCC"))) ? $mycolor[red]() : null -->red<!-- /ko -->; '
    );

    result = elaborateDeclarations(
      'color: red; -ko-color: @mycolor; -ko-color-ifnot: !mycondition || true ? myobj.color : "red"',
      undefined,
      templateUrlConverter,
      mockedBindingProvider
    );
    expect(result).toEqual(
      'color: red; color: <!-- ko text: !(((!$mycondition[undefined]() || true) ? $myobj.color[undefined]() : "red")) ? $mycolor[red]() : null -->red<!-- /ko -->; '
    );
  });
  ...
  it('should expect defaults', function () {
    ...
    try {
      result = elaborateDeclarations(
        'color: red blue; -ko-color: @a @b @c @d',
        undefined,
        templateUrlConverter,
        mockedBindingProvider
      );
  ...
  it('should raise an exception on unknown tokens in condition expressions', function () {
    ...
    try {
      result = elaborateDeclarations(
        'color: red; -ko-color: @mycolor; -ko-color-if: mycondition gt 1 xor mycondition lt 3',
        undefined,
        templateUrlConverter,
        mockedBindingProvider
      );
    ...
    try {
      result = elaborateDeclarations(
        'color: red; -ko-color: @mycolor; -ko-color-if: mycondition gtn 1',
        undefined,
        templateUrlConverter,
        mockedBindingProvider
      );
  ...
  it('should raise an exception on unbalanced string values', function () {
    ...
    try {
      result = elaborateDeclarations(
        'color: red; -ko-color: @mycolor; -ko-color-if: mycondition eq "ciao ciao"a',
        undefined,
        templateUrlConverter,
        mockedBindingProvider
      );
  ...
  it('should raise an exception when -if and -ifnot are used on the same property', function () {
    ...
    try {
      result = elaborateDeclarations(
        'color: red; -ko-color-ifnot: mycondition; -ko-color: @mycolor; -ko-color-if: mycondition eq "ciao ciao"',
        undefined,
        templateUrlConverter,
        mockedBindingProvider
      );
  ...
  it('should raise errors on bad modifiers', function () {
    ...
    try {
      result = elaborateDeclarations(
        "src: url('path'); -ko-src: @[myurl!mymod]",
        undefined,
        templateUrlConverter,
        mockedBindingProvider
      );
  ...
  it('should camel case stles but not attributes', function () {
    ...
    result = elaborateDeclarations(
      '-ko-attr-data-attribute: @myvalue; background-color: red; -ko-background-color: @mycolor',
      undefined,
      templateUrlConverter,
      mockedBindingProvider,
      $('a')[0]
    ...
    expect(
      "virtualAttr: { 'data-attribute': $myvalue[ciao]() }, virtualAttrStyle: 'background-color: '+($mycolor[red]())+';'+''"
    ).toEqual($('a').attr('data-bind'));
  });
});
