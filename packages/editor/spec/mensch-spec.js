...
describe('Mensch parser', function () {
  it('should return expected positions', function () {
    ...
    replacedText = utils.removeStyle(
      replacedText,
      styleSheet.stylesheet.rules[1].position.start,
      styleSheet.stylesheet.rules[1].position.end,
      0,
      0,
      0,
      'CCC'
    ...
    replacedText = utils.removeStyle(
      replacedText,
      declarations[0].position.start,
      declarations[0].position.end,
      0,
      0,
      0,
      'BBB'
    ...
    replacedText = utils.removeStyle(
      replacedText,
      styleSheet.stylesheet.rules[0].position.start,
      styleSheet.stylesheet.rules[0].position.end,
      0,
      0,
      0,
      'AAA'
  ...
  it('should return expected positions 2', function () {
    ...
    replacedText = utils.removeStyle(
      replacedText,
      declarations[1].position.start,
      declarations[1].position.end,
      0,
      0,
      0,
      'D:E'
