...
<template>
  <aside class="bs-user-modals-confirmation">
    <bs-modal-confirm
      ...
      >{{ $t('users.enableNotice') }} <b>{{ user.name | capitalizeEach }}</b
      >?</bs-modal-confirm
    >
    <bs-modal-confirm
    ...
    <bs-modal-confirm
      ...
      >{{ this.$t('users.passwordNotice.reset') }}
      <b>{{ user.name | capitalizeEach }}</b
      >?</bs-modal-confirm
    >
