...
<template>
  <v-list>
    ...
    <v-list-item link v-if="user.isDeactivated" @click.stop="showActivateDialog">
      <v-list-item-avatar>
    ...
    <template v-if="!user.isDeactivated">
      <!-- send password -->
      <v-list-item link v-if="actionDisplay.sendPassword" @click.stop="showSendPasswordDialog">
        <v-list-item-avatar>
          <v-icon>vpn_key</v-icon>
        </v-list-item-avatar>
        <v-list-item-content>
          <v-list-item-title>{{$t('users.passwordTooltip.send')}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <!-- re-send password -->
      <v-list-item link v-if="actionDisplay.reSendPassword" @click.stop="showReSendPasswordDialog">
        <v-list-item-avatar>
          <v-icon>vpn_key</v-icon>
        </v-list-item-avatar>
        <v-list-item-content>
          <v-list-item-title>{{$t('users.passwordTooltip.resend')}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <!-- reset password -->
      <v-list-item link v-if="actionDisplay.resetPassword" @click.stop="showResetPasswordDialog">
        <v-list-item-avatar>
          <v-icon>vpn_key</v-icon>
        </v-list-item-avatar>
        <v-list-item-content>
          <v-list-item-title>{{$t('users.passwordTooltip.reset')}}</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
      <!-- deactivate -->
      <v-list-item link @click.stop="showDeactivateDialog" :disabled="loading" color="primary">
        <v-list-item-avatar>
