...
import BsGroupFeedMappingsTab from '~/components/group/feed-mappings-tab.vue';
import { IS_ADMIN, USER } from '~/store/user';
import { Plus } from 'lucide-vue';

export default {
  name: 'BsPageSettingsFeedMappings',
  components: {
    BsPageHeader,
    BsGroupFeedMappingsTab,
    LucidePlus: Plus,
  },
  ...
  methods: {
    openCreateForm() {
      this.$refs.feedMappingsTab.openCreateForm();
    },
  },
};
</script>
  ...
  <div>
    ...
    <v-container fluid>
      <div class="settings-content">
        <bs-group-feed-mappings-tab ref="feedMappingsTab" />
      </div>
    </v-container>
  </div>
</template>
