export default {
  ...
  groups: {
    ...
    modules: {
      ...
      deliverability: {
        name: 'Deliverability',
        description: 'Deliverability audits and reputation monitoring',
      },
    },
  },
  deliverability: {
    ...
    modules: {
      inventory: {
        ...
        description: 'Document platforms, domains, IPs, and infrastructure',
      },
      mapping: {
        title: 'Infrastructure Mapping',
        description: 'Visualize and organize your email infrastructure',
      },
      dns: {
        title: 'DNS Analysis',
        description: 'Check SPF, DMARC, DKIM, and DNS records',
      },
    },
    mapping: {
      title: 'Infrastructure Mapping',
      ...
      fields: {
        ...
        usage: 'Use case',
        selectUsage: 'Select a use case',
        fromDomains: 'Display-From domains',
        fromAddresses: 'Display-From addresses',
        ips: 'IPs',
        mailFrom: 'Mail-From domains',
        replyTo: 'Reply-To',
        trackingDomains: 'Tracking domains',
        hostingDomains: 'Hosting domains',
        linkDestinationDomains: 'Link destination domains',
        sharedIps: 'Shared / mutualized IPs',
        comments: 'Comments',
        commentsPlaceholder: 'Notes, context, observations…',
      },
      group: {
        defaultName: 'New group',
        rename: 'Rename group',
        delete: 'Delete group',
        empty: 'Drag lines here or add one below',
      },
      sidebar: {
        title: 'Inventory',
    ...
    inventory: {
      ...
      saveError: 'Failed to save inventory. Please try again.',
      completed: 'Technical Inventory completed!',
      ...
      steps: {
        ...
        usages: {
          title: 'Use cases',
          description: 'Document the different types of emails you send and their purposes',
          placeholder: 'e.g., Newsletter: Monthly sends to subscribers\nTransactional: Order confirmations',
        },
        displayFromDomains: {
        ...
        displayFromAddresses: {
          ...
          description: 'Enter the complete email addresses shown to recipients',
          placeholder: 'e.g., newsletter@company.com',
        },
        replyTos: {
          title: 'Reply-To addresses',
          description: 'Enter the email addresses where replies should be sent',
          placeholder: 'e.g., support@company.com',
        },
        mailFromDomains: {
          title: 'Mail-From domains',
          description: 'Enter the technical sender domains used in the Return-Path',
          placeholder: 'e.g., bounce.company.com',
        },
        trackingDomains: {
          title: 'Tracking domains',
          description: 'Enter the domains used for tracking opens and clicks',
        ...
        ips: {
          title: 'IP addresses',
          description: 'Enter the IP addresses used for sending emails',
    ...
    audits: {
      ...
      createPrompt: 'Create your first deliverability audit to get started',
      loadingAudits: 'Loading audits...',
      createDialog: {
        title: 'Create new audit',
        nameLabel: 'Audit name',
      ...
      card: {
        ...
        deleteDialog: {
          ...
          error: 'Failed to delete audit. Please try again.',
        },
      },
      status: {
        draft: 'Draft',
      ...
      editDialog: {
        ...
        error: 'Failed to update audit. Please try again.',
      },
    },
    mailingTab: {
