export default {
  ...
  aiPlayground: {
    ...
    list: {
      empty: 'No scenario yet. Create one to start testing a skill.',
      noLastRun: 'Never run',
    },
    filters: {
      skill: 'Skill',
    ...
    form: {
      ...
      inputSection: 'Additional input (JSON)',
      inputHint: 'This object is merged with the expertise list to form the skill\'s final input.',
