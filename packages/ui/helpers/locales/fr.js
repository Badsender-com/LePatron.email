export default {
  ...
  crmIntelligence: {
    ...
    admin: {
      ...
      dashboardsCount: 'tableau(x) de bord',
      createSuccess: 'Intégration créée',
      deleteSuccess: 'Intégration supprimée',
      deleteError: 'Erreur lors de la suppression',
      deleteConfirmTitle: 'Supprimer l\'intégration ?',
      deleteConfirmText: 'Cette action est irréversible. Tous les tableaux de bord associés seront supprimés.',
      // Dashboards
      dashboards: 'Tableaux de bord',
      addDashboard: 'Ajouter',
      dashboardId: 'ID Metabase',
      dashboardIdHint: 'Numéro du dashboard dans Metabase',
      dashboardName: 'Nom',
      dashboardDescription: 'Description',
      dashboardOrder: 'Ordre',
      removeDashboard: 'Supprimer',
