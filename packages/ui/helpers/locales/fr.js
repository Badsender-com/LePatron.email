export default {
  ...
  groups: {
    ...
    modules: {
      ...
      deliverability: {
        name: 'Délivrabilité',
        description: 'Audits de délivrabilité et monitoring de réputation',
      },
    },
  },
  deliverability: {
    ...
    modules: {
      inventory: {
        ...
        description: 'Documenter les plateformes, domaines, IPs et infrastructure',
      },
      mapping: {
        title: 'Cartographie d\'infrastructure',
        description: 'Visualiser et organiser votre infrastructure email',
      },
      dns: {
        title: 'Analyse DNS',
        description: 'Vérifier les enregistrements SPF, DMARC, DKIM et DNS',
      },
    },
    mapping: {
      title: 'Cartographie d\'infrastructure',
      ...
      fields: {
        ...
        usage: 'Cas d\'usage',
        selectUsage: 'Sélectionner un cas d\'usage',
        fromDomains: 'Domaines Display-From',
        fromAddresses: 'Adresses Display-From',
        ips: 'IPs',
        mailFrom: 'Domaines Mail-From',
        replyTo: 'Reply-To',
        trackingDomains: 'Domaines de tracking',
        hostingDomains: 'Domaines d\'hébergement',
        linkDestinationDomains: 'Domaines de destination des liens',
        sharedIps: 'IPs partagées / mutualisées',
        comments: 'Commentaires',
        commentsPlaceholder: 'Notes, contexte, observations…',
      },
      group: {
        defaultName: 'Nouveau groupe',
        rename: 'Renommer le groupe',
        delete: 'Supprimer le groupe',
        empty: 'Faites glisser des lignes ici ou ajoutez-en une',
      },
      sidebar: {
        title: 'Inventaire',
        ...
        hostingDomains: 'Domaines d\'hébergement',
        linkDestinationDomains: 'Domaines de destination des liens',
        noItems: 'Aucun élément dans l\'inventaire',
      },
      empty: {
    ...
    inventory: {
      title: 'Inventaire technique',
      saved: 'Inventaire enregistré avec succès',
      saveError: 'Échec de l\'enregistrement. Veuillez réessayer.',
      completed: 'Inventaire technique terminé !',
      ...
      steps: {
        platforms: {
          ...
          description: 'Listez tous les ESP (Email Service Providers) que vous utilisez pour envoyer des emails',
          placeholder: 'ex: Brevo, Actito, Adobe Campaign',
        },
        usages: {
          title: 'Cas d\'usage',
          description: 'Documentez les différents types d\'emails que vous envoyez et leurs objectifs',
          placeholder: 'ex: Newsletter: Envois mensuels aux abonnés\nTransactionnel: Confirmations de commande',
        },
        displayFromDomains: {
        ...
        displayFromAddresses: {
          ...
          description: 'Saisissez les adresses email complètes affichées aux destinataires',
          placeholder: 'ex: newsletter@company.com',
        },
        replyTos: {
          title: 'Adresses Reply-To',
          description: 'Saisissez les adresses email où les réponses doivent être envoyées',
          placeholder: 'ex: support@company.com',
        },
        mailFromDomains: {
          title: 'Domaines Mail-From',
          description: 'Saisissez les domaines techniques utilisés dans le Return-Path',
          placeholder: 'ex: bounce.company.com',
        },
        trackingDomains: {
          title: 'Domaines de tracking',
          description: 'Saisissez les domaines utilisés pour le suivi des ouvertures et clics',
          placeholder: 'ex: track.company.com',
        },
        hostingDomains: {
        ...
        ips: {
          title: 'Adresses IP',
          description: 'Saisissez les adresses IP utilisées pour l\'envoi des emails',
    ...
    audits: {
      ...
      createFirstAudit: 'Créer le premier audit',
      noAuditsYet: 'Aucun audit',
      createPrompt: 'Créez votre premier audit de délivrabilité pour commencer',
      loadingAudits: 'Chargement des audits...',
      createDialog: {
        title: 'Créer un nouvel audit',
        nameLabel: 'Nom de l\'audit',
        nameRequired: 'Ce champ est obligatoire',
        statusLabel: 'Statut',
        cancel: 'Annuler',
        create: 'Créer',
        success: 'Audit créé avec succès',
        error: 'Échec de la création de l\'audit. Veuillez réessayer.',
      },
      card: {
        organization: 'Organisation',
        created: 'Créé le',
        lastUpdated: 'Dernière modification',
        inventoryProgress: 'Progression de l\'inventaire',
        workshopReady: 'Prêt pour l\'atelier',
        edit: 'Modifier',
        delete: 'Supprimer',
        deleteDialog: {
          title: 'Supprimer l\'audit ?',
          message: 'Êtes-vous sûr de vouloir supprimer <strong>{name}</strong> ? Cette action est irréversible.',
          cancel: 'Annuler',
          confirm: 'Supprimer',
          success: 'Audit supprimé avec succès',
          error: 'Échec de la suppression de l\'audit. Veuillez réessayer.',
        },
      },
      status: {
        draft: 'Brouillon',
      ...
      editDialog: {
        ...
        workshopReady: 'Prêt pour l\'atelier',
        save: 'Enregistrer',
        success: 'Audit mis à jour avec succès',
        error: 'Échec de la mise à jour de l\'audit. Veuillez réessayer.',
      },
    },
    mailingTab: {
