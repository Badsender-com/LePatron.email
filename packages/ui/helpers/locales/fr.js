export default {
  ...
  aiPlayground: {
    ...
    list: {
      empty: 'Aucun scénario pour le moment. Créez-en un pour commencer à tester une skill.',
    ...
    form: {
      ...
      inputSection: 'Input additionnel (JSON)',
      inputHint: 'Cet objet est fusionné avec les expertises pour former l\'input final de la skill.',
