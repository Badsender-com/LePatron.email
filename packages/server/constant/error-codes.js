...
module.exports = {
  ...
  ASSET_NAME_ALREADY_EXISTS: 'ASSET_NAME_ALREADY_EXISTS',
  ASSET_TYPE_REQUIRED: 'ASSET_TYPE_REQUIRED',
  ASSET_INVALID_TYPE: 'ASSET_INVALID_TYPE',
  ASSET_IN_USE: 'ASSET_IN_USE',
  ASSET_CONNECTION_FAILED: 'ASSET_CONNECTION_FAILED',
  FAILED_ASSET_DELETE: 'FAILED_ASSET_DELETE',
  FAILED_ASSET_UPDATE: 'FAILED_ASSET_UPDATE',

  // EXPORT PROFILES
  EXPORT_PROFILE_NOT_FOUND: 'EXPORT_PROFILE_NOT_FOUND',
  EXPORT_PROFILE_NAME_ALREADY_EXISTS: 'EXPORT_PROFILE_NAME_ALREADY_EXISTS',
  EXPORT_PROFILE_INVALID_CONFIG: 'EXPORT_PROFILE_INVALID_CONFIG',
  FAILED_EXPORT_PROFILE_DELETE: 'FAILED_EXPORT_PROFILE_DELETE',
};
