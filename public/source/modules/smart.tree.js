            ...
            class extends Smart.Button {
                  ...
                  if (t) {
                    ...
                    for (let t = 0; t < n.length; t++) {
                      ...
                      r.checked &&
                        (r.name
                          ? (a.push(r.name),
                            e.id && r.setAttribute('data-id', e.id))
                          : e.id && a.push(e.id));
                    }
                    (t.value = a.toString()),
              ...
              _changeCheckState(e) {
                ...
                null === t.checked
                  ...
                  t.checked
                    ? t.$.fireEvent('checkValue', { changeType: e })
                    : t.$.fireEvent('uncheckValue', { changeType: e }),
                  t._updateGroupValue(),
                  t._setAriaState();
              }
              _handleTextSelection() {
                ...
                e.$.addClass('smart-unselectable'),
                  ...
                  (e.timer = setTimeout(
                    () => e.$.removeClass('smart-unselectable'),
                    500
                  ));
              }
              propertyChangedHandler(e, t, n) {
              ...
              _htmlBindOnInitialization() {
                ...
                e._bindContentProperty('trueContent', 'smart-true-content'),
                  e._bindContentProperty('falseContent', 'smart-false-content'),
                  e._bindContentProperty(
                    'indeterminateContent',
              ...
              _handleTemplate(e, t) {
                ...
                if (
                  (!0 === e
                    ...
                    : !1 === e
                    ? ((a = n.falseTemplate),
                      (r = n.$.falseContentContainer),
                      (i = n.falseContent))
                    : ((a = n.indeterminateTemplate),
                ...
                for (let e = 0; e < c; e++) {
                  ...
                  for (let t = 0; t < h; t++)
                    p.innerHTML = p.innerHTML.replace(d[e].bindingString, i);
                }
                r.innerHTML = '';
                for (let e = 0; e < m.childNodes.length; e++)
                  m.childNodes[e].outerHTML &&
                    (r.innerHTML += m.childNodes[e].outerHTML);
              }
            }
          );
        ...
        !(function () {
          ...
          class i {
            static animate(e, t, r, o) {
              ...
              if (
                ((s =
                  window[n].EnableShadowDOM && i.shadowRoot
                    ? i.shadowRoot.host.shadowRoot.querySelector(
                        '.smart-ripple'
                      )
                    : i.getElementsByClassName('smart-ripple')[0]),
                !s)
              )
                return;
              (s.innerHTML = ''),
              ...
              (s.style.left = u + 'px'),
                ...
                s.addEventListener('animationend', function e() {
                  s.parentElement && s.parentElement.removeChild(s),
                    ...
                    s.removeEventListener('animationcancel', e);
                }),
          ...
          class s {
            ...
            static easeInOutBack(e, t, n, r, o) {
              return (
                void 0 === o && (o = 1.70158),
                (e /= r / 2) < 1
                  ? (n / 2) * (e * e * ((1 + (o *= 1.525)) * e - o)) + t
                  : (n / 2) *
                      ((e -= 2) * e * ((1 + (o *= 1.525)) * e + o) + 2) +
                    t
              );
            }
            ...
            static easeInOutBounce(e, t, n, r) {
              return e < r / 2
                ...
                : 0.5 * this.easeOutBounce(2 * e - r, 0, n, r) + 0.5 * n + t;
            }
          }
          class a {
            static get isMobile() {
              const e = /(iphone|ipod|ipad|android|iemobile|blackberry|bada)/.test(
                  ...
                  if (
                    ...
                    for (let e, t = 0; (e = o[t]); t++)
                      i +=
                        ...
                        e.name +
                        '="' +
                        e.value.replace(/[&\u00A0"]/g, y.Core.escapeHTML) +
                        '"';
                    (i += '>'),
                      [
                        'area',
          ...
          class h {
              ...
              if (
                ...
                if (Smart.Utilities.Core.Browser.Firefox) {
                  ...
                  (e.className = 'smart-resize-trigger-container'),
                    ...
                    window[n].EnableShadowDOM && t.target.shadowRoot
            ...
            handleDown(e) {
              ...
              return (
                (t.handlers.tap || t.handlers.taphold) && t.initTap(n),
            ...
            handleSwipeEvents(e) {
              ...
              return (
                (t.handlers.swipetop || t.handlers.swipebottom) &&
                  (n = this.handleVerticalSwipeEvents(e)),
                !1 === n ||
                  ((t.handlers.swipeleft || t.handlers.swiperight) &&
                    (n = this.handleHorizontalSwipeEvents(e))),
                n
              );
            }
            ...
            swiped(e, t, n) {
              ...
              if (
                ((n = n || 0),
                Math.abs(t) >= r.swipeMin && !r._swipeEvent && !r._swipeLocked)
              ) {
                ...
                if (
                  ...
                  r[o] &&
                    (r[o](this._swipeEvent), Math.abs(t) <= this.swipeMax))
                )
          ...
          class f {
            ...
            fireEvent(e, t, r) {
              ...
              if (
                ((i.originalStopPropagation = i.stopPropagation),
                (i.stopPropagation = function () {
                  return (
                    (i.isPropagationStopped = !0), i.originalStopPropagation()
                  );
                }),
                o.dispatchEvent(i),
                window[n].isVue)
              ) {
                const t = y.Core.toDash(e);
                if (t !== e) {
                  const e = new CustomEvent(t, r);
                  (e.originalStopPropagation = i.stopPropagation),
                ...
                ? void 0 === o
                  ? (r.element.removeAttribute(e),
                    r.element.shadowRoot &&
                      r.element.$.root &&
                      r.element.$.root.removeAttribute(e))
                  : (r.element.setAttribute(e, o),
                    r.element.shadowRoot &&
                      r.element.$.root &&
          ...
          class C extends HTMLElement {
            ...
            getBindings(e, t) {
              ...
              i && (o.data = i),
                t || ((o.mapping = []), (t = o)),
                e.getAttribute &&
                  ((o.nodeId = e.getAttribute('smart-id')),
                  t && i && (t.mapping[o.nodeId] = i)),
                (o.node = e),
                e.firstChild && (o.children = {});
            ...
            parseProperty(e, t) {
              ...
              return (
                ...
                c
                  ? ((r.type = c.type),
                    (r.reflectToAttribute = c.reflectToAttribute))
                  : ([
                      'checked',
                      'selected',
                      'async',
            ...
            updateBoundMappedNodes() {
              ...
              if (t.mapping)
                for (let r in t.mapping) {
                  ...
                  if (
                    (n.shadowRoot &&
                      ((o = n.querySelector('[id="' + r + '"]')),
                      o ||
                        (o =
                          n.shadowRoot.querySelector('[id="' + r + '"]') ||
                    ...
                    if (
                      (!i &&
                        n.shadowRoot &&
                        (i = n.shadowRoot.getElementById(
                          n.getAttribute('aria-controls')
                        )),
                      (o = i.querySelector('[smart-id="' + r + '"]')),
                      o)
                    ) {
                      const i = t.mapping[r];
                      e.updateBoundData(o, i, n);
                ...
                if (
                  ...
                  if ('innerHTML' === a) {
                    if (e[i].toString().trim() !== n[a].toString().trim()) {
                      if (window.smartBlazor && e[i].indexOf('\x3c!--') >= 0) {
                        (s.ready ||
                          n._properties[a].defaultValue !== s.value) &&
                          (e[i] = s.value.toString());
                        continue;
                      }
                      (s.ready || n._properties[a].defaultValue !== s.value) &&
                        (e[i] = s.value.toString().trim());
                    }
                  } else
                    s.not
                      ? ((e[i] = !s.value),
                        s.targetPropertyName &&
                          (e[s.targetPropertyName] = !s.value))
                      : ((e[i] = s.value),
                        s.targetPropertyName &&
                          (e[s.targetPropertyName] = s.value));
                  if (e.$ && e.$.isNativeElement) {
                    ...
                    !s.reflectToAttribute ||
                      ...
                      s.reflectToAttribute ||
                        e.$.setAttributeValue(t, null, s.type);
                  }
                  if (!s.ready) {
                    if (e.$ && e.$.isCustomElement) {
                      ...
                      const t = v.cache['toDash' + i];
                      e._properties ||
                        (e._beforeCreatedProperties = e._properties = e.propertyByAttributeName = []),
                        e._properties[i] ||
                          ((e._properties[i] = { attributeName: t }),
                          e._beforeCreatedProperties &&
                            (e._beforeCreatedProperties[i] = e._properties[i]),
                          (e.propertyByAttributeName[t] = e._properties[i]));
                      ...
                      (n.isUpdating = !0),
                        ...
                        s.reflectToAttribute ||
                          e.$.setAttributeValue(n.attributeName, null, s.type),
                        (n.isUpdating = !1);
                    }
                    if (s.twoWay) {
                      const t = function (t) {
                      ...
                      if (e.$ && e.$.isCustomElement) {
                        e._properties[i] && (e._properties[i].notify = !0),
                          v.cache['toDash' + i] ||
                            (v.cache['toDash' + i] = y.Core.toDash(i));
                        ...
                        o['$' + e.getAttribute('smart-id')].listen(
                          ...
                          function (e) {
                            ...
                            e.context !== document && (o.context = o),
                              o.updateBoundProperty(s.name, s),
                              (o.context = r);
                          }
                        );
                      }
                ...
                if (
                  ...
                  for (let e in t.dataContextProperties) {
                    ...
                    if (
                      ...
                      v.cache['toDash' + e] ||
                        (v.cache['toDash' + e] = y.Core.toDash(o)),
                      r.isEvent)
                    ) {
                      const e = r.value;
            ...
            setup() {
              ...
              e.ownerElement &&
                ...
                e.initProperties(),
                a.isMobile && e.classList.add('smart-mobile');
              ...
              for (let t in e._properties) {
                ...
                if (
                  ...
                  (n.isUpdating = !0),
                    e.$.setAttributeValue(n.attributeName, n.value, n.type),
                    (n.isUpdating = !1);
                }
              }
              const t = [];
                    ...
                    n.isCompleted ||
                      ...
                      n._onCompleted ||
                        ...
                        (n._onCompleted = function () {
                          for (let e = 0; e < n.completeHandlers.length; e++)
                            n.completeHandlers[e]();
                        })),
            ...
            refreshTemplate() {
                  ...
                  if (s.data)
                    for (let t in s.data) {
                      ...
                      if (
                        ...
                        (r.value = o[i.substring('item.'.length)]),
                          (a[t] = r.value);
                      else if (i.indexOf('item') >= 0 && void 0 !== o)
              ...
              r(e.templateBindings.children, n),
            ...
            addModule(e, t) {
              ...
              if (
                ...
                n.defineElementProperties(e.properties),
                    ...
                    if (
                      ...
                      (e._properties[n] = {
                        ...
                        defaultReflectToAttributeConditions:
                          i.defaultReflectToAttributeConditions,
                        value: a,
                        readOnly: i.readOnly,
                        defaultValue: a,
                      ...
                      (e.propertyByAttributeName[i.attributeName] =
                        e._properties[n]),
            ...
            defineElementProperties(e) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        if (
                          ...
                          const e = r.localize('propertyInvalidValueType', {
                            name: o,
                      ...
                      if (
                        (!t.isUpdatingFromAttribute &&
                          ...
                          r.$.setAttributeValue(t.attributeName, n, t.type),
                        r.isReady &&
                          (!r.ownerElement ||
                        ...
                        if (r.context !== r && !r.wait) {
                          const e = r.context;
                          (r.context = r),
                            r.propertyChangedHandler(o, i, n),
                            (r.context = e),
                            t.observer &&
                              r[t.observer] &&
                              ((r.context = r),
                            ...
                            r._watch &&
                              ...
                              r._watch.propertyChangedCallback(o, i, n);
                        }
                        const e = t.notify || r.boundProperties[o];
                        e &&
                          (r.$.fireEvent(t.attributeName + '-changed', {
                            context: r.context,
                            oldValue: i,
                            value: r[o],
                          }),
              ...
              for (let t = 0; t < r.length; t += 1) {
                ...
                d && 'any' !== l && (s.type = l.substring(0, l.length - 1)),
                  ...
                  (s.name = i),
                  (s.reflectToAttribute =
                    void 0 === s.reflectToAttribute || s.reflectToAttribute),
          ...
          class D {
            static register(e, t) {
              ...
              if (!_[e]) {
                if (e.startsWith(n.toLowerCase()))
                  _[e] = window[n][o] = window[n.toLowerCase() + o] = t;
                else {
                  let r = e.split('-')[0];
                  (r = r.substring(0, 1).toUpperCase() + r.substring(1)),
                    window[n][r] || (window[n][r] = {}),
                    (_[e] = window[n][r][o] = window[r.toLowerCase() + o] = t),
                    window[n][o] && (o = a.toCamelCase(e)),
                    (window[n][o] = t);
                }
                (r.elementName = o),
                  r.defineElement(),
              ...
              try {
                n || r
                  ? !n && r
                    ...
                    : n &&
                      r &&
                      (r.proto && (n(r.proto), t(r.proto)), (S[e] = void 0))
                  : (S[e] = function (e) {
                      try {
                        t(e);
                      } catch (e) {
              ...
              if (e) {
                ...
                if (t) {
                  if (((D.tagNames[e] = t), D.lazyRegister)) {
                    ...
                    return (
                      (window[n][e] = t),
                      void D.toRegister.push({ tagName: r, element: t })
                    );
                  }
                  D.register(r, t);
                }
          ...
          const B = function () {
            if (
              ...
              for (let e = 0; e < x.length; e++)
                (window[n].RenderMode = ''),
                  (x[e].element.isLoading = !1),
                  x[e].callback(),
                  (window[n].RenderMode = '');
              (x = []), document.removeEventListener('readystatechange', B);
            }
          };
          Object.assign(window[n], {
            ...
            BaseElement: class extends C {
              ...
              _setupShadowRoot() {
                ...
                const t = (t) => {
                  t.$.root &&
                    (t.$.root.classList.add(n.toLowerCase() + '-element'),
                    t.$.root.classList.add(e.nodeName.toLowerCase())),
                    t.setup(),
              ...
              connect() {
                ...
                window[n].EnableShadowDOM &&
                  ...
                  e.shadowRoot &&
                    e.$.root &&
                    (e.shadowRoot.appendChild(e.$.root),
                    e.$.root.classList.add(e.nodeName.toLowerCase()))),
                  e.shadowRoot || e.shadowParent
                    ? e.shadowRoot
                      ? e._setupShadowRoot()
              ...
              connectedCallback() {
                ...
                if (
                  ...
                  for (
                    let t = 0;
                    t < e.parents.length &&
                    !e.parents[t].nodeName
                      .toLowerCase()
                      .startsWith(n.toLowerCase() + '-');
                    t++
                  )
                    if (
                      e.parents[t].hasAttribute('ng-version') &&
                      !e.classList.contains('smart-angular')
                    ) {
              ...
              const r = function (e, t) {
                return new Promise((n) => {
                  ...
                  for (let e = 0; e < document.head.children.length; e++) {
                    ...
                    if (r.src && r.src.toString().indexOf(t) >= 0)
                      return void n();
                  }
            ...
            Component: class {
              constructor(e, t) {
                ...
                return (
                  e
                    ? (r = new window[n](e, t))
                    : ((r = new window[n]()), (r._initProperties = t)),
                  (this._element = r),
                  r
                );
              }
            ...
            Theme: P.Theme || '',
            EnableShadowDOM: P.ShadowDom || !1,
            BaseUrl: './',
            StyleBaseUrl: '/styles/default/',
            Version: e,
            Templates: t,
            RenderMode: P.RenderMode || 'auto',
            Render: function () {
              const e = () => {
          ...
          'manual' !== window[n].RenderMode &&
            ...
            window[n](
              ...
              class extends window[n].ContentElement {
                ...
                _touchmoveHandler(e) {
                  ...
                  const i = e.touches[0];
                  let s, a, l, d;
                  (t._touchCoords = [i.pageX, i.pageY]),
                    n
                      ? ((s = t.scrollTop),
                        (a = t.scrollHeight),
                        (l = i.pageY),
                      ...
                      return (
                        ...
                        void (
                          ...
                          t.scrollTo(
                            void 0,
                            t.scrollLeft +
                              t._getScrollCoefficient(e, t.offsetWidth)
                          )
                        )
                      );
                    }
                ...
                refreshScrollBarsVisibility() {
                  ...
                  e._scrollView &&
                    ...
                    e.computedVerticalScrollBarVisibility
                      ? (e._scrollView.hScrollBar.$.addClass('bottom-corner'),
                        e._scrollView.vScrollBar.$.addClass('bottom-corner'))
                      : (e._scrollView.hScrollBar.$.removeClass(
                          'bottom-corner'
                        ),
                        e._scrollView.vScrollBar.$.removeClass(
                          'bottom-corner'
                        )));
                }
                ready() {
                ...
                refresh() {
                  const e = this;
                  function t() {
                    const t = e.$.scrollViewerContainer.classList.contains(
                      'vscroll'
                    );
                  ...
                  function n() {
                    let t;
                    const n = e.$.scrollViewerContainer.classList.contains(
                      'hscroll'
                    );
                    if (
                      (e.$.scrollViewerContainer.classList.remove('hscroll'),
                      ...
                      t =
                        n && r
                          ...
                          : e.$.scrollViewerContentContainer.offsetHeight -
                  ...
                  (e.scrollWidth = t()),
                    ...
                    0 === e.scrollHeight &&
                      ...
                      e.$.container.offsetHeight - e.$.content.offsetHeight <
                        5 &&
                      (e.$.container.style.paddingBottom =
                        e._scrollView.hScrollBar.offsetHeight + 'px'),
                    e.autoRefresh &&
            ...
            window[n].Utilities.Assign(
              ...
              class {
                ...
                handleAutoPositioning() {
                  ...
                  return (r = n(function i() {
                    t.isHidden ||
                      ...
                      t.isHidden && cancelAnimationFrame(r),
                      Date.now() - o >= 200 &&
                ...
                checkBrowserBoundsHorizontally() {
                  ...
                  if (
                    (i < 0 &&
                      ((t.style.left = (n ? 0 : Math.abs(i)) + 'px'),
                      (i = parseFloat(t.style.left))),
                    i + t.offsetWidth > o)
                  ) {
                    let e = i - Math.abs(o - i - t.offsetWidth);
                    n && (e += window.pageXOffset),
                      (t.style.left = (n ? e : e - i) + 'px'),
                      window.innerWidth ===
                        document.documentElement.clientWidth &&
                        (t.style.left = parseFloat(t.style.left) + r + 'px'),
                      n &&
                        window.innerHeight ===
                ...
                positionDropDown(e) {
                  ...
                  if (this.customPositionDropDown) {
                    ...
                    switch (
                      ((o = r.left), (i = r.top), t._dropDownListPosition)
                    ) {
                      case 'bottom':
            ...
            (window.Smart.Color = class {
              ...
              getInvertedColor() {
                ...
                return e['#' + this.hex.toUpperCase()]
                  ? e['#' + this.hex.toUpperCase()]
                  : 255 - (0.299 * this.r + 0.587 * this.g + 0.114 * this.b) <
                    105
                  ? 'Black'
                  : 'White';
              }
                ...
                return (
                  6 === (e = this.validateHex(e)).length
                    ? ((t = e.substring(0, 2)),
                      ...
                      (r = e.substring(4, 6)))
                    : (e.length > 4 &&
                        ((t = e.substring(4, e.length)),
                        (e = e.substring(0, 4))),
                      e.length > 2 &&
                        ((n = e.substring(2, e.length)),
                        (e = e.substring(0, 2))),
                      e.length > 0 && (r = e.substring(0, e.length))),
                  {
                    r: this.hexToInt(t),
                    g: this.hexToInt(n),
                    b: this.hexToInt(r),
                ...
                if (
                  ...
                  switch (e) {
                    case 'checkable':
                      ...
                      break;
                    case 'checkMode':
                      o.itemContainer.setAttribute('check-mode', n),
                        i._changeToRadioButtonMode(n, o.itemContainer, o),
                        i._updateItemRoles(o);
                      break;
                    case 'disabled': {
                      if (Smart.ListMenu && i instanceof Smart.ListMenu) {
                        if (i._view)
                          for (; o.contains(i._view); )
                            i._backButtonClickHandler();
                      } else
                        i._isContainerOpened(o.container.level, o.container) &&
                          i._closeSubContainers(o.level + 1, o.container);
                      if (!o.checked) return;
                      o.checked = !1;
                      const e = a.checkMode;
                      'radioButton' === e
            ...
            class extends Smart.BaseElement {
              ...
              addItem(e, t) {
                ...
                if (((e.isDirty = !1), void 0 === t))
                  (o = n), (i = 1), (r = t = n.$.mainContainer);
                else {
                  if ((t = n.getItem(t)) instanceof Smart.MenuItemsGroup == 0)
                    return;
                  (o = t), (i = t.level + 1), (r = t.itemContainer);
                }
                if (
                  (n._createItemHTMLStructure(e, i, t, r.childElementCount, 0),
                  e instanceof Smart.MenuItemsGroup &&
                    (n._processHTML(e, i + 1), n._checkContainersLength()),
                  r.appendChild(e),
              ...
              collapseItem(e, t) {
                ...
                if (
                  void 0 === (e = n.getItem(e)) ||
                  e instanceof Smart.MenuItem
                )
                  return;
                const r = e.level;
                if (
                  n._openedContainers[r + 1] &&
                  n._isContainerOpened(r + 1, e.container)
                ) {
                  const t = n.mode;
                  i && (n.animation = 'none'),
              ...
              expandItem(e, t) {
                ...
                if (
                  void 0 === (e = n.getItem(e)) ||
                  (e instanceof Smart.MenuItemsGroup &&
                    n._isContainerOpened(e.level + 1, e.container) &&
                    n._isBranchExpanded(e))
                )
                  return;
                ...
                for (
                  ...
                  o.unshift(a), (a = a.parentItem);
                for (let e = 0; e < o.length; e++) {
                  const t = o[e];
                  if (e === o.length - 1 && t instanceof Smart.MenuItem) {
                    t.disabled || t.templateApplied || n._hoverViaKeyboard(t);
                    break;
                  }
                  n._isContainerOpened(t.container.level, t.container) ||
              ...
              getItem(e) {
                ...
                if (null != e && t._menuItems) {
                  ...
                  if (
                    ...
                    (t.contains(n) ||
                      t.$.mainContainer.contains(n) ||
                      n.parentElement.parentElement.ownerElement === t)
                  )
                    return n;
                }
              }
              ...
              open(e, t) {
                ...
                if (((n.opened = !0), n._positionRelativeTo)) {
                  ...
                  (e += i.left),
                    (t += i.top),
                    n._positionedParent
                      ? ((o = n._positionedParent.getBoundingClientRect()),
                        (e -= o.left),
                        (t -= o.top))
              ...
              propertyChangedHandler(e, t, n) {
                ...
                if ('tree' !== o._element)
                  switch (e) {
                    ...
                    case 'dataSource': {
                      let e = !1;
                      o._minimized && (o.maximize(), (e = !0)),
                        o._removeContainersInBody(),
                        (o._containersInBody = []),
                        (o._menuItems = {}),
                        o._processDataSource(),
                        o._checkContainersLength(),
                        e ? o.minimize() : i(),
                        o._expandItemsByDefault(),
                        o._refreshCheckableItems(),
                        (o._suppressResizeHandler = !0),
                        setTimeout(() => delete o._suppressResizeHandler, 500);
                      break;
                    }
                    case 'innerHTML':
                    ...
                    case 'dropDownAppendTo': {
                      ...
                      for (let e = 0; e < o._containersFixedHeight.length; e++)
                        ...
                        if (
                          ...
                          'tree' === t || o._minimized
                            ? (o._closeSubContainersTreeMode(
                              ...
                              (o._openedContainers = []))
                            : o._closeSubContainersDefaultMode(2),
                          o._discardKeyboardHover(!0),
                          o._minimized &&
                            o._minimizedDropDownOpened &&
                      ...
                      if (null !== o.dropDownAppendTo)
                        for (let t = 0; t < o._containers.length; t++) {
                          ...
                          i.setAttribute(Smart.Utilities.Core.toDash(e), n),
                            i.level > 2 &&
                              o._setArrowDirection(
                                i.menuItemsGroup.children[0].children[1],
                                i.level
                              );
                        }
                      break;
                      ...
                      if ('tree' !== o.mode) {
                        ...
                        if (null !== o.dropDownAppendTo) {
                          n
                            ...
                            : o.$.mainContainer.removeAttribute(
                                'right-to-left'
                              );
                          for (let e = 0; e < o._containers.length; e++) {
              ...
              _addOpenedContainer(e, t) {
                ...
                if ('tree' === n.mode || n._minimized) {
                  ...
                  return (
                    ...
                    n._updateState && n._updateState('expanded', o.id, !0),
                    n._openedContainers[e].push(t)
                  );
                }
              ...
              _applyGrouping(e, t) {
                ...
                for (let e = 0; e < o.length; e++) {
                  const i = o[e];
                  (i.originalIndex = e),
                    i instanceof Smart.MenuItemsGroup &&
                      void 0 === t &&
                      n._applyGrouping(i);
                }
                n._sortItems(e);
                ...
                if (null === e) {
                  ...
                  if (null !== o && 'template' === o.tagName.toLowerCase()) {
                    ...
                    n.$hamburgerIconLineTop.addClass('smart-hidden'),
                      ...
                      (n.$.customIconContainer.innerHTML = ''),
                      n.$.customIconContainer.appendChild(e),
              ...
              _arrowRightHandler(e, t, n, o) {
                ...
                1 === e
                  ...
                  : n instanceof Smart.MenuItemsGroup
                  ? i._selectionHandler({ target: n, isTrusted: !0 })
                  : i._levelOneNavigateFromLowerLevel(
              ...
              _changeToRadioButtonMode(e, t, n) {
                if ('radioButton' === e) {
                  ...
                  for (let n = 0; n < t.childElementCount; n++) {
                    ...
                    !o.checked || o.disabled || o.templateApplied || e.push(o);
                  }
                  ...
                  m
                    ? 'auto' === r
                      ? (e.classList.add('scroll-buttons-shown'),
                        ...
                        !1 === (c && u) && e.classList.add('one-button-shown'),
                        o.disabled ||
              ...
              _checkOverflowAddRemove(e, t) {
                ...
                (1 === e && null !== n.dropDownAppendTo) || 'tree' === n.mode
                  ...
                  : e > 1 &&
                    t.dropDownHeightSet &&
                    (n._isContainerOpened(e, t.container)
                      ? n._checkOverflow(t, !1, [
              ...
              _closeSubContainersDefaultMode(e, t, n) {
                ...
                function r(t) {
                  ...
                  (n && t === e) ||
                    ...
                    r.$.removeClass('smart-menu-items-group-opened'),
                    r.$.removeClass('smart-menu-items-group-expanded'),
                    ...
                    o.$.fireEvent('collapse', {
                      ...
                      path: r.path,
                      value: r.value,
                      children: r.itemContainer.children,
                    }),
                    (i[t] = void 0);
                }
              ...
              _closeSubContainersTreeMode(e, t, n, o, i) {
                ...
                if (
                  ...
                  if (n) {
                    ...
                    e && (e.$.removeClass('focus'), e.removeAttribute('focus')),
                      a.$.addClass('focus'),
                      a.setAttribute('focus', ''),
                      (r._focusedViaKeyboard = a);
                ...
                if (
                  ...
                  r.toggleCallback
                    ? ((e.type = 'collapse'), r.toggleCallback(e))
                    : r.$.fireEvent('collapse', e);
                }
              ...
              _collapseAll(e, t) {
                const n = this;
                for (
                  let o = n._openedContainers.length - 1;
                  o >= 2 && void 0 !== n._openedContainers[o];
                  o--
                )
                  for (let i = n._openedContainers[o].length - 1; i >= 0; i--)
                    n._closeSubContainersTreeMode(
                      o,
                      n._openedContainers[o][i],
                      void 0,
                      e,
                      t
                    );
              ...
              _createElement() {
                ...
                e.setAttribute('role', 'menu'),
                  ...
                  e._positionDetection.getDropDownParent(),
                  e._reparentMenu(),
                  e.disabled &&
              ...
              _createItemHTMLStructure(e, t, n, o) {
                ...
                if (
                  ...
                  e.set(
                    'shortcut',
                    e.shortcut || e.getAttribute('shortcut') || ''
                  ),
              ...
              _createMenuItemsGroupContainer(e, t) {
                ...
                for (let e = 0; e < o.length; e++) {
                  ...
                  if (
                    t.classList &&
                    (t.classList && t.classList.contains(i)
                      ? (a = t)
                      : t.classList && t.classList.contains(r) && (s = t),
                    a && s)
                  )
                    break;
                }
                if (
                  ...
                  (s.container = a),
                  (s.menuItemsGroup = e),
                  e.checkable && s.setAttribute('checkable', ''),
                  s.setAttribute('check-mode', e.checkMode),
                  ...
                  t || (t = document.createElement('smart-repeat-button')),
                    ...
                    t.setAttribute('aria-label', 'Scroll up'),
                    (t.innerHTML =
                      '<div class="smart-arrow smart-arrow-up" aria-hidden="true"></div>'),
                    (t.animation = n.animation),
                    (t.unfocusable = !0),
                    (t.rightToLeft = n.rightToLeft),
                    (o.className =
                      'smart-menu-scroll-button smart-spin-button smart-scroll-button-far smart-hidden'),
                    o.setAttribute('aria-label', 'Scroll down'),
                    (o.innerHTML =
                      '<div class="smart-arrow smart-arrow-down" aria-hidden="true"></div>'),
                    (o.animation = n.animation),
                    (o.unfocusable = !0),
                    (o.rightToLeft = n.rightToLeft),
                    a.contains(t) || a.insertBefore(t, s),
                    a.contains(o) || a.appendChild(o),
                    a.$.addClass('drop-down-height-set'),
                    (s.dropDownHeightSet = !0),
                    (s.checkOverflow = !0),
                    (a.style.height = e.dropDownHeight + 'px'),
                    n._containersFixedHeight.push(a),
                    n._additionalScrollButtons.push([t, o]);
                }
                return a;
              }
              _discardKeyboardHover(e) {
                ...
                t._focusedViaKeyboard &&
                  ((!e &&
                    t._focusedViaKeyboard instanceof Smart.MenuItemsGroup &&
                    t._isContainerOpened(
                      t._focusedViaKeyboard.level + 1,
                      t._focusedViaKeyboard.container
                    )) ||
                    (t._focusedViaKeyboard.$.removeClass('focus'),
                    t._focusedViaKeyboard.removeAttribute('focus'),
                    t._focusedViaKeyboard.$.removeClass('hover'),
              ...
              _documentUpHandler(e) {
                ...
                if (
                  (t.isInShadowDOM
                    ? ((i = t.isInShadowDOM
                        ? t.getRootNode().activeElement
                        : (t.shadowRoot && t.shadowRoot.activeElement) ||
                          document.activeElement),
                      (r = t.$.container.contains(
                        e.originalEvent.composedPath()[0]
                      )))
                ...
                if (o.top > t.top) l = r._getOffsetTop(e);
                  ...
                  let n = e.expanded
                    ? e.firstElementChild.offsetHeight +
                      parseInt(
                        window.getComputedStyle(e.children[1]).marginTop,
                        10
                      )
                    : e.offsetHeight;
                  if (
              ...
              _getOffsetTop(e) {
                if (!e) return 0;
                let t = e.offsetTop;
                for (; e.offsetParent !== this.$.mainContainer; ) {
                  if (!(e = e.offsetParent)) return t;
                  t += e.offsetTop;
                }
                return t;
              }
                    ...
                    : ((e.$.scrollButtonNear.disabled = e.disabled),
                      ...
                      'auto' === n
                        ...
                        : (t.classList.add('scroll-buttons-shown'),
                          ...
                          e.$scrollButtonNear.removeClass('smart-hidden'),
                          e.$scrollButtonFar.removeClass('smart-hidden'),
                          e._updateScrollButtonVisibility(t, o, [
                            e.$.scrollButtonNear,
                            e.$.scrollButtonFar,
                          ]))),
                  e._scrollInfo.set(t, {
                  ...
                  case 'ArrowLeft':
                    r
                      ? 1 === m
                        ...
                        ? t._selectionHandler({ target: l, isTrusted: !0 })
                        : t._levelOneNavigateFromLowerLevel(
                            '_getPreviousEnabledChild',
                            l
                          )
                      : t._arrowLeftHandler(m, o, l, d);
                    break;
                  case 'ArrowRight':
                    r
                      ? 1 === m
              ...
              _keydownHandlerTreeMode(e) {
                ...
                function s() {
                  o.level > 1 &&
                    ...
                    t._hoverViaKeyboard(o.parentItem));
                }
                let l;
                switch (e) {
                  case 'ArrowDown':
                  ...
                  case 'ArrowLeft':
                    ...
                    if (o instanceof Smart.MenuItem) s();
                      ...
                      if (t._isContainerOpened(o.level + 1, o.container))
                        return void t._closeSubContainers(
                          o.level + 1,
                          o.container,
                          !0,
                          !0
                  ...
                  case 'ArrowRight':
                    ...
                    t._isContainerOpened(o.level + 1, o.container)
                      ? (o.$.removeClass('focus'),
                        o.removeAttribute('focus'),
                        t._hoverViaKeyboard(
                          t._getFirstEnabledChild(o.itemContainer)
                        ))
                      : t._selectionHandler(
                          { target: o, type: 'keydown', isTrusted: !0 },
                          o
                        );
                    break;
                  case 'ArrowUp':
                  ...
                  case 'End':
                    ...
                    break;
                  case 'Enter':
                    t._minimized && !t._minimizedDropDownOpened
                      ? t._hamburgerIconClickHandler(void 0, t.$.mainContainer)
                      : o &&
                        t._selectionHandler({
                          target: o,
                          type: 'keydown',
                ...
                if (e.disabled || e.templateApplied) o();
                  ...
                  if (!n._toggleItem(e)) {
                    ...
                    if (
                      ...
                      return (
                        n._ripple(e, t),
                        void n.close({ trigger: 'interaction', target: e })
                      );
                  }
                  n._ripple(e, t), o();
                }
              ...
              _menuItemsGroupSelectionHandler(e, t, n) {
                ...
                if (o._isContainerOpened(a, r))
                  ...
                  if (
                    ...
                    return;
                  if (
                    (o._positionDetection.placeOverlay(),
                    ...
                    if (s) 'keydown' === t.type && (o._focusedViaKeyboard = e);
                      ...
                      t &&
                        (t.$.removeClass('focus'), t.removeAttribute('focus')),
                        (o._focusedViaKeyboard = e);
                    }
                  ...
                  if (
                    ...
                    r.itemContainer.checkOverflow &&
                      r.itemContainer.dropDownHeightSet &&
                      (o._checkOverflow(r.itemContainer, !1, [
                        r.children[0],
                        r.children[2],
                      ]),
                  ...
                  o._positionExternalContainer(r, e),
                    ...
                    void 0 === t.type &&
                      o._hoverViaKeyboard(
                        o._getFirstEnabledChild(e.itemContainer)
                      ),
                    !1 !== n &&
                      o.$.fireEvent('expand', {
                        item: e,
                ...
                if (
                  ...
                  if (null !== t.dropDownAppendTo && e.relatedTarget)
                    if (t.contains(e.target)) {
                      ...
                      if (n && n.ownerElement === t) return;
                    } else if (t.contains(e.relatedTarget)) return;
                  (t._isElementHovered = !1),
                    (t._autoCloseTimeout = setTimeout(function () {
                      const e = t.context;
                      clearTimeout(t._autoCloseTimeout),
                        t._isElementHovered ||
                          ((t.context = t), t._close(), (t.context = e));
                    }, t.autoCloseDelay));
                }
              }
              ...
              _moveDropDownsToExternalContainer() {
                ...
                for (let t = 0; t < e._containersInBody.length; t++) {
                  ...
                  e._dropDownParent.appendChild(n),
                    n.$.listen('click', e._selectionHandler.bind(e)),
                    n.$.listen('mouseleave', e._mouseleaveHandler.bind(e)),
                    n.$.listen('mouseout', e._mouseoutMouseoverHandler.bind(e)),
                    n.$.listen(
                      'mouseover',
                      e._mouseoutMouseoverHandler.bind(e)
                    );
                }
                for (let t = 0; t < e._containers.length; t++) {
                  const n = e._containers[t];
                  (n.ownerElement = e),
                    ...
                    n.setAttribute('drop-down-position', e.dropDownPosition),
              ...
              _processDataSource() {
                ...
                function s(t, r) {
                  ...
                  if (Array.isArray(t[o]) && t[o].length > 0) {
                    ...
                    (a = document.createElement(
                      'smart-' + e._element + '-item'
                    )),
                      void 0 !== t.shortcut && a.set('shortcut', t.shortcut),
                      t.customAttribute &&
                        a.setAttribute(t.customAttribute, '');
                  (a.isDirty = !1),
                    void 0 !== t.id &&
                      /^[A-Za-z]+[\w\-\:\.]*$/.test(t.id) &&
                      (a.id = t.id),
                ...
                (r.innerHTML = ''),
                  r instanceof Smart.ScrollViewer && r.removeAll();
              ...
              _processHTML(e, t, n) {
                ...
                for (let n = 0; n < a.length; n++) {
                  ...
                  const i = a[n];
                  i instanceof Smart.MenuItem ||
                  i instanceof Smart.MenuItemsGroup
                    ? (o._createItemHTMLStructure(i, t, e, n - d),
                      ...
                      t > 1 && l.appendChild(i),
                      i instanceof Smart.MenuItemsGroup &&
                        o._processHTML(i, t + 1))
                    : (i.parentElement.removeChild(i), d++);
                }
                if (t > 1) {
                  if (
                    (r.appendChild(l),
                  ...
                  o._containers.push(i),
                    ...
                    o._minimized
                      ...
                      : ((i.ownerElement = o),
                        o.rightToLeft
                          ? i.setAttribute('right-to-left', '')
                          : i.removeAttribute('right-to-left'),
                        i.classList.add('smart-drop-down-repositioned'),
                        i.setAttribute('mode', o.mode),
                        i.setAttribute(
                          'drop-down-position',
                          o.dropDownPosition
                        ),
                        ...
                        2 === t
                          ? (o._dropDownParent.appendChild(i),
                            ...
                            i.$.listen(
                              'mouseleave',
                              o._mouseleaveHandler.bind(o)
                            ),
                            i.$.listen(
                              'mouseout',
                              o._mouseoutMouseoverHandler.bind(o)
                            ),
                            i.$.listen(
                              'mouseover',
                              o._mouseoutMouseoverHandler.bind(o)
              ...
              _refreshContainersArrays() {
                ...
                for (let t = e._containers.length - 1; t >= 0; t--) {
                  ...
                  if (!document.body.contains(n)) {
                    ...
                    o > -1 &&
                      (e._containersFixedHeight.splice(o, 1),
                      e._additionalScrollButtons.splice(o, 1));
                  }
                }
                ...
                if (e.parentElement === t.$.container)
                  (r = n),
                    ...
                    'horizontal' === t.mode
                      ...
                      : ((n.scrollTop = n.scrollTop + 10 * i),
                        t._updateScrollButtonVisibility(n, !1, [
                          t.$.scrollButtonNear,
                          t.$.scrollButtonFar,
                        ]));
                else {
                  ...
                  (r = o),
                    ...
                    t._updateScrollButtonVisibility(o, !1, [
                      n.children[0],
                      n.children[2],
                    ]);
                }
              ...
              _selectionHandler(e, t) {
                ...
                if (
                  ...
                  if (void 0 === t) {
                    ...
                    const i = o.closest('smart-' + n._element + '-item');
                    if (i) return void n._menuItemSelectionHandler(i, e);
                    if (
                      (t = o.closest('smart-' + n._element + '-items-group')) &&
                      (o === t.container || o === t.container.firstElementChild)
                    )
                      return;
                  }
                ...
                if (null !== i && 'template' === i.tagName.toLowerCase()) {
                  ...
                  if (n instanceof Smart.MenuItem)
                    ...
                    for (let t = 0; t < r.childNodes.length; t++)
                      e.test(r.childNodes[t].innerHTML)
                        ? ((n.titleLabel = e.exec(
                            r.childNodes[t].innerHTML
                          )[1]),
                          (r.childNodes[t].innerHTML = r.childNodes[
                            t
                          ].innerHTML.replace(e, '')))
                        : e.test(r.childNodes[t].textContent) &&
                          ((n.titleLabel = e.exec(
                            r.childNodes[t].textContent
                          )[1]),
                          (r.childNodes[t].textContent = r.childNodes[
                            t
                          ].textContent.replace(e, '')));
                    void 0 === n.titleLabel && (n.titleLabel = r.textContent),
                      t.appendChild(r);
                    ...
                    return (
                      ...
                      ('checkbox' === o.checkMode
                        ...
                        : 'radioButton' !== o.checkMode ||
                          ...
                          e.set('checked', !0),
                          e.setAttribute('aria-checked', !0),
                          t._uncheckSiblings(e, o.siblings),
                          t.$.fireEvent('itemCheckChange', {
                            item: e,
                            label: e.label,
                            value: e.value,
              ...
              _transitionendHandlerCollapse() {
                ...
                t.menuItemsGroup.$.removeClass(
                  'smart-' + e._element + '-items-group-expanded'
                ),
                  t.menuItemsGroup.setAttribute('aria-expanded', !1),
              ...
              _transitionendHandlerExpand() {
                ...
                t.removeEventListener(
                  ...
                  e._minimized && e._browserBoundsDetection(e.$.mainContainer),
                  e._ensureVisibleOnTransitionend &&
                    (e._ensureVisible(e._ensureVisibleOnTransitionend),
                ...
                if (
                  ...
                  if (d && m)
                    return (
                      n[0].$.removeClass('smart-hidden'),
                      n[1].$.removeClass('smart-hidden'),
                      void e.classList.remove('one-button-shown')
                    );
                  d
                    ? n[0].$.removeClass('smart-hidden')
                    : n[0].$.addClass('smart-hidden'),
            ...
            _changeCheckState(e) {
              ...
              if ((!0 === t.checked && 'api' === e) || !1 === t.checked)
                if (o.length > 0) t._changeCheckStateInGroup(o, e);
                  ...
                  let r = t.parentNode;
                  t.getRootNode().host
                    ? ((r = t.getRootNode().host.parentNode),
            ...
            _changeCheckStateInGroup(e, t) {
              ...
              n.nativeElement
                ? (n.nativeElement.$.fireEvent('change', {
                  ...
                  n.nativeElement.$.fireEvent('checkValue', { changeType: t }))
                : (n.$.fireEvent('change', {
                    value: !0,
                    oldValue: !1,
                    changeType: t,
            ...
            _trackClickHandler(t) {
              ...
              'horizontal' === e.orientation
                ? r > (e._isThumbDragged ? e.dragStartX : a.right)
                  ...
                  : r < (e._isThumbDragged ? e.dragStartX : a.left) &&
                    e._updateValue(
                      e.value - (e.rightToLeft ? -1 : 1) * e.largeStep
                    )
                : n > (e._isThumbDragged ? e.dragStartY : a.bottom)
          ...
          class extends Smart.MenuItem {
            ...
            propertyChangedHandler(e, t, r) {
              ...
              switch (((o.context = o), e)) {
                ...
                case 'selected':
                  (n.selected = t), r ? o.select(n) : o.unselect(n);
                  break;
                case 'shortcut': {
          ...
          Smart(
            ...
            class extends Smart.MenuItemsGroup {
              ...
              propertyChangedHandler(e, t, r) {
                ...
                switch (((o.context = o), e)) {
                  case 'expanded':
                    (n.expanded = t), r ? o.expandItem(n) : o.collapseItem(n);
                    break;
                  case 'label': {
                    const e = o.sorted && o.autoSort;
                    (n.firstElementChild.firstElementChild.firstElementChild.innerHTML = r),
          ...
          Smart(
            ...
            class extends Smart.Menu {
              ...
              addTo(e, t) {
                ...
                let n, o;
                if (((e.isDirty = !1), void 0 === t))
                  (n = 1), (o = t = r.$.mainContainer);
                else {
                  if ((t = r.getItem(t)) instanceof Smart.TreeItemsGroup == 0) {
                ...
                let i = arguments[2];
                i && arguments[3] && (i = i.nextElementSibling),
                  i
                    ? (o.insertBefore(e, i),
                      (r._menuItems = {}),
                      r._refreshItemPaths(
                    ...
                    : o.appendChild(e),
                  l && r._applyGrouping(r.$.mainContainer),
                  a && r._applyFilter(a),
                  r._checkOverflow(),
                  ...
                  (() => {
                    ...
                    if (window.screen.availWidth < 400)
                      return (
                        ...
                        void (t.style.height = e.offsetHeight + 'px')
                      );
                    {
                      const r = {
              ...
              closeDropDown() {
                ...
                e.dropDownMode &&
                  e.$.dropDownPopup &&
                  ((e._isOpened = !1),
                  e.$.dropDownElement.removeAttribute('active'),
                  e.$.dropDownElement
                    .querySelector('.smart-drop-down-button')
                  ...
                  (r.open = function (n, o) {
                    r.removeEventListener('transitionend', r.remove),
                      ...
                      requestAnimationFrame(function () {
                        ...
                        const e = function (e, n) {
                          ...
                          switch (
                            ...
                            case 'bottom':
                              return Math.max(
                                o.top,
                                o.top + t.offsetHeight - r.offsetHeight
                              );
                            case 'center':
                              return Math.max(
                                o.top,
                                o.top + t.offsetHeight / 2 - r.offsetHeight / 2
                              );
                            case 'left':
                              return o.left;
                            case 'middle':
                              return (
                                o.left + t.offsetWidth / 2 - r.offsetWidth / 2
                              );
                            case 'right':
                        ...
                        (r.style.left = e(n, 'horizontal') + 'px'),
                          (r.style.top = e(o, 'vertical') + 'px'),
                          (r.setPosition = (t, n) => {
                            n
              ...
              _renderInDropDown() {
                ...
                if (
                  e.dropDownMode &&
                  (e.dropDownMode && (e.style.display = 'none'),
                  ...
                  if (
                    ...
                    (e.$.dropDownPopup = r),
                    (t.onmouseenter = () => {
                      t.hasAttribute('active') || t.setAttribute('hover', '');
                    }),
                    (t.onmouseleave = () => {
                    ...
                    (t.innerHTML = `<div class="smart-container" role="presentation">\n                <div class="smart-content" role="presentation">\n                    <div class="smart-buttons-container" role="presentation">\n                        <span class="smart-action-button">${e.localize(
                      'dropDownPlaceholder'
                    ...
                    (e._popupDropDown = r),
                      (r._refreshPosition = () => {
                        ...
                        if (
                          ((r.style.maxHeight = ''),
                          (r.style.minHeight = ''),
                          n.top + o + r.offsetHeight >
                            window.innerHeight - l.top)
                        ) {
                          const e =
                            o +
                            n.top +
                            ...
                            l.top;
                          (r.style.maxHeight =
                            Math.max(250, r.offsetHeight - e) + 'px'),
                            (r.style.minHeight = '250px');
                        } else
                          (r.style.maxHeight = ''), (r.style.minHeight = '');
                      });
                    const n = () => {
                      const r = e.getSelectedValues();
                      r &&
                        r.length &&
                        (t.querySelector('.smart-action-button').innerHTML =
                          r[0]);
                    };
                    (r.onOpen = function () {
                      e._popupDropDown._refreshPosition(),
                        e.$.fireEvent('open'),
                        e.$.listen('change', n);
                    }),
                      (r.onClose = function () {
              ...
              expandItem(e, t) {
                ...
                if (
                  ...
                  e instanceof Smart.TreeItemsGroup == 0 ||
                  (e &&
                    e.container &&
              ...
              insert(e, t) {
                ...
                if (
                  ...
                  n = (function e(t) {
                    ...
                    if (
                      ...
                      t[r.displayMember] && (l.label = t[r.displayMember]),
                      ...
                      if ((t.expanded && (l.expanded = !0), n))
                        for (let t = 0; t < n.length; t++)
                          l.appendChild(e(n[t]));
                    } else t.shortcut && (l.shortcut = t.shortcut);
                    return l;
                  })(e);
                }
                ...
                1 === o.length
                  ...
                  : ((a = r._menuItems[t]),
                    (l = r._menuItems[o.slice(0, o.length - 1).join('.')]),
                    a
                      ? r.addBefore(n, a)
                      : l &&
              ...
              loadState(e) {
                ...
                for (let r = 0; r < e.selected.length; r++) {
                  const o = t.getItem(e.selected[r]);
                  o && n.push(o.path);
                }
                  ...
                  case 'expandMode':
                    if ('single' === r) {
                      ...
                      for (let r = 0; r < e.length; r++) {
                        ...
                        t[l] = !0;
                        const a = e.filter(
                          (e) => e !== o && e.parentItem === l
                        );
                        a.length > 0 && a.forEach((e) => n.collapseItem(e));
                      }
                    }
                    break;
                  case 'filterable':
                ...
                for (let s = 0; s < o.length; s++) {
                  ...
                  e.selected && i.set('selected', !0),
                    i instanceof Smart.TreeItemsGroup
                      ? r._applyHierarchicalSelection(i, t)
                      : i.selected && t.push(i.path),
                    n &&
                      (i.selected
                        ? l++
                        : i.hasAttribute('indeterminate') && a++);
                }
                n &&
              ...
              _applySelection(e, t) {
                ...
                switch ((r._sortPathCollection(n), l)) {
                  case 'none':
                    n.length = 0;
                    for (let e = 0; e < a.length; e++) a[e].set('selected', !1);
                    break;
              ...
              _autoLoadState(e) {
                ...
                for (let n = 0; n < e.selected.length; n++) {
                  const o = t.getItem(e.selected[n]);
                  o && r.push(o.path);
                }
                t.selectedIndexes = r;
              }
                ...
                o
                  ? 'auto' === r
                    ? (t.$.addClass('scroll-buttons-shown'),
                      ...
                      !1 === (l && a) && t.$.addClass('one-button-shown'),
                      e.disabled ||
              ...
              _documentUpHandler(e) {
                ...
                if ((delete t._editInputDown, o)) {
                  const r =
                    l.closest('smart-tree-item') ||
                    l.closest('smart-tree-items-group');
                  !r ||
                    !r.selected ||
                    r !== o ||
                    (t._dragDetails && t._dragDetails.FeedbackShown) ||
                    (r instanceof Smart.TreeItemsGroup &&
                      (l.closest('.smart-tree-items-group-arrow') ||
                        l === r.container ||
                        l === r.container.firstElementChild)) ||
                    t._handleSelection(r, e);
                }
                if (
                  t.dropDownMode &&
                  t._isOpened &&
                  !l.closest('smart-tree') &&
                  !l.closest('.smart-tree-drop-down-button')
                )
                  return (
                    t.closeDropDown(),
                    e.originalEvent.preventDefault(),
                ...
                if (
                  ...
                  return;
                const i =
                  a || t.getRootNode().elementFromPoint(e.clientX, e.clientY);
                let d;
                document.body.classList.remove('smart-dragging'),
                ...
                if (!a || !a.allowDrop || a.disabled) return;
                const p = [a];
                let h;
                if (
                ...
                if (
                  ...
                  a.sorted && a.autoSort && a._unsortItems(a.$.mainContainer);
                  for (let e = 0; e < u.length; e++)
                    t._moveTreeItem(u[e], s, d, p);
                  a.sorted && a.autoSort && a._applyGrouping(a.$.mainContainer),
                    a !== t &&
                      a._state.filter &&
                ...
                if (
                  ...
                  if ('Enter' !== e.key) return;
                  {
                    ...
                    (t.context = t),
                      ...
                      t.$.fireEvent('filterChange', {
                        value: t.$.filterInput.value,
                      }),
                      t._checkOverflow(),
                      (t.context = e);
                  }
                        ...
                        o instanceof Smart.TreeItem
                          ...
                          : (o.expanded && (l.expanded = !0),
                            ...
                            o.itemContainer &&
                              ...
                              e(o.itemContainer.children, l.items)),
                        r.push(l);
                    }
              ...
              _handleHierarchicalSelection(e, t) {
                ...
                for (
                  ...
                  for (let e = 0; e < t.length; e++)
                    t[e].selected
                      ? o++
                      : t[e].hasAttribute('indeterminate') && l++;
                  r._setThreeStateCheckbox(e, o, l), (n = e);
                }
                e instanceof Smart.TreeItemsGroup &&
                  (function e(t, r) {
                    ...
                    for (let t = 0; t < n.length; t++) {
                      ...
                      o.set('selected', r),
                        ...
                        o instanceof Smart.TreeItemsGroup && e(o, r);
                    }
                  })(e, e.selected),
                  (t.length = 0);
                const o = Array.from(
              ...
              _handleSelection(e, t) {
                ...
                switch (n) {
                  ...
                  case 'zeroAndOne':
                    if (o) return;
                    r._menuItems[a[0]] &&
                      (r._menuItems[a[0]].set('selected', !1),
                      r._menuItems[a[0]].removeAttribute('aria-selected')),
                    ...
                    if ((!n && !o) || (o && e === r._lastSelectedItem)) {
                      for (let e = 0; e < a.length; e++)
                        r._menuItems[a[e]].set('selected', !1),
                          r._menuItems[a[e]].setAttribute('aria-selected', !1);
                      (a = [e.path]),
                        e.set('selected', !0),
                        e.setAttribute('aria-selected', !0),
                        (r._lastSelectedItem = e);
                    } else if (n)
                      e.selected && a.length > 1
                        ? (a.splice(a.indexOf(e.path), 1),
                          e.set('selected', !1),
                          e.setAttribute('aria-selected', !1))
                        : e.selected ||
                      ...
                      for (let e = 0; e < a.length; e++)
                        r._menuItems[a[e]].set('selected', !1),
                          r._menuItems[a[e]].setAttribute('aria-selected', !1);
                      a = r._selectItemRange(r._lastSelectedItem, e);
                    }
                    r.selectedIndexes = a;
                    break;
                  }
                  case 'checkBox':
                    r.hasThreeStates
                      ? r._handleHierarchicalSelection(e, a)
                      : o
                      ? (a.splice(a.indexOf(e.path), 1),
                        e.set('selected', !1),
                        e.setAttribute('aria-selected', !1))
                ...
                if (
                  ...
                  r._updateState('selected'),
                  JSON.stringify(l) !== JSON.stringify(r.selectedIndexes))
                ) {
                  if (r.ownerElement && !r.ownerElement.isRendered) return;
                  r.$.fireEvent('change', {
                    item: e,
                    selectedIndexes: r.selectedIndexes,
                    oldSelectedIndexes: l,
                  });
                }
              }
              _hoverViaKeyboard(e, t, r, n) {
                ...
                const o = this;
                e.setAttribute('focus', ''),
                  (o._hoveredViaKeyboard = e),
                  !1 !== n && o._ensureVisible(e),
              ...
              _keydownHandler(e) {
                ...
                function i() {
                  l.level > 1 &&
                    t._canItemBeSelected(l.parentItem) &&
                    (l.removeAttribute('focus'),
                    t._hoverViaKeyboard(l.parentItem, o, e));
                }
                let d;
                switch (r) {
                  case 'ArrowDown':
                    (d = l ? n.indexOf(l) + 1 : 0), a(d);
                    break;
                  case 'ArrowLeft':
                    if (!l) return;
                    if (l instanceof Smart.TreeItem) i();
                    else {
                      if (t._isContainerOpened(l.level + 1, l.container))
                    ...
                    break;
                  case 'ArrowRight':
                    if (!l || l instanceof Smart.TreeItem) return;
                    if (t._isContainerOpened(l.level + 1, l.container)) {
                      const r = t._getFirstEnabledChild(l.itemContainer);
                      r &&
                        (l.removeAttribute('focus'),
                        t._hoverViaKeyboard(r, o, e));
                    } else
                      t._menuItemsGroupSelectionHandler(l, {
                        target: l,
                        type: 'keydown',
                      });
                    break;
                  case 'ArrowUp':
                    (d = l ? n.indexOf(l) - 1 : n.length - 1), s(d);
                    break;
                  case 'End':
                    s(n.length - 1);
                    break;
                  case 'Enter':
                    ...
                    break;
                  case 'F2':
                    t.editable && t._startEditing(l);
                    break;
                  case 'Home':
                    a(0);
                    break;
                  case 'PageDown':
                    t._pageDownHandler(n, l, o, e);
                    break;
                  case 'PageUp':
                    t._pageUpHandler(n, l, o, e);
                    break;
                  case ' ':
              ...
              _menuItemsGroupSelectionHandler(e, t, r) {
                ...
                if (
                  ...
                  n._isContainerOpened(s, a))
                )
                  n._closeSubContainersTreeMode(s, a, !0, !1 !== r);
                else {
                  if (
              ...
              _moveHandler(e) {
                ...
                if (!r.FeedbackShown) {
                  ...
                  if (
                    ...
                    return (
                      ...
                      delete Smart.Tree.hoveredTree,
                      delete Smart.Tree.hoveredItem,
                      void (t.$.scrollViewer._scrollView.disableSwipeScroll = !1)
                    );
                ...
                if (
                  ...
                  t._isMobile ||
                    ((l = e.originalEvent.target),
                    l &&
                      l.enableShadowDOM &&
                      (l = e.originalEvent.composedPath()[0]),
                    l &&
                      l.closest &&
                      (a =
                        l.closest('smart-tree-item') ||
                  ...
                  a instanceof Smart.TreeItem
                    ? e.clientY - t.top <= t.height / 2
                      ? (a.classList.remove('bottom'), a.classList.add('top'))
                      : (a.classList.remove('top'), a.classList.add('bottom'))
                    : e.clientY - t.top <= 10
                    ? (a.classList.remove('bottom'), a.classList.add('top'))
                    : !a.expanded && t.bottom - e.clientY <= 10
                    ? (a.classList.remove('top'), a.classList.add('bottom'))
                    : (a.classList.remove('top'), a.classList.remove('bottom')),
              ...
              _moveSubItems(e, t, r) {
                ...
                for (let o = 0; o < e.length; o++) {
                  const l = e[o];
                  (l.menu = t),
                    l.set('level', l.parentItem.level + 1),
                    (l.firstElementChild.style.paddingLeft = ''),
                    (l.firstElementChild.style.paddingRight = ''),
                    n._setIndentation(l.firstElementChild, l.level, r),
                    (l.hidden = !1),
                    l.$.removeClass('smart-hidden'),
                    l.$.removeClass('filtered-child'),
                    l.$.removeClass('last-filtered-child'),
                    l instanceof Smart.TreeItemsGroup &&
                      (l.$.removeClass('hidden-children'),
                      (l.container.level = l.level + 1),
                      n._moveSubItems(l.itemContainer.children, t, r),
                      t !== n &&
                        l.expanded &&
                        (t._menuItemsGroupsToExpand.push(l),
              ...
              _moveTreeItem(e, t, r, n) {
                ...
                if (
                  ...
                  e instanceof Smart.TreeItemsGroup &&
                    ...
                    o._moveSubItems(e.itemContainer.children, n[0], a),
                    e.expanded))
                ) {
                  ...
                  for (let t = e.length - 1; t >= 0; t--) {
                    ...
                    if (
                      ...
                      o._getOffsetTop(r) + r.firstElementChild.offsetHeight <=
                        l.scrollTop + l.$.container.offsetHeight
                    )
                      return r;
                  }
                }
              ...
              _continueSelection(e, t) {
                ...
                let l;
                if (n instanceof Smart.TreeItem) l = '_handleSelection';
                else {
                  if (e === n.container || e === n.container.firstElementChild)
                    return;
                  l = '_menuItemsGroupSelectionHandler';
                }
                if (
              ...
              _selectItemRange(e, t) {
                ...
                for (let e = Math.min(o, l); e <= Math.max(o, l); e++) {
                  ...
                  r._canItemBeHovered(t) &&
                    (a.push(t.path), t.set('selected', !0));
                }
                return a;
              }
              ...
              _startEditing(e) {
                ...
                t.rightToLeft
                  ...
                  : ((n = function () {
                      return (
                        a.offsetLeft +
                        parseFloat(window.getComputedStyle(l).borderLeftWidth)
                      );
                    }),
                    (o = 'paddingLeft')),
                  e instanceof Smart.TreeItemsGroup
...
License: https://htmlelements.com/license/ */ class smartTree extends Smart.Component {
        get name() {
          return 'smartTree';
        }
      }
